...
local screenshot_selected = function() awful.spawn(SCROT_CMD) end
...
for i = 1, 9 do
  globalkeys = gears.table.join(globalkeys,
    ...
    -- Toggle tag display.
    awful.key({ modkey, "Control" }, "#" .. i + 9, get_tag_function("toggle_tag", i),
      { description = t.toggle_tag .. i, group = t.tag }),
    -- Move client to tag.
    awful.key({ modkey, "Shift" }, "#" .. i + 9, get_tag_function("move_focused_to_tag", i),
      { description = t.move_focused_to_tag .. i, group = t.tag }),
    -- Toggle tag on focused client.
    awful.key({ modkey, "Control", "Shift" }, "#" .. i + 9, get_tag_function("toggle_focused_on_tag", i),
